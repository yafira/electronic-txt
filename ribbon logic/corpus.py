...
powered by moonlight powered by moonlight powered by a warm battery powered by a warm battery powered by usb power powered by usb power powered by a shared charge powered by static
felt velvet tulle cloud fiber industrial felt knit silicone foam mesh gel
laced with ribbon logic laced with ribbon logic woven in loops that remember woven in loops that remember stitched with running thread stitched with running thread
buttons that only work if you are gentle buttons that only work if you are gentle a cursor that waits for your breath a cursor that waits for your breath
a keyboard that blushes when touched a keyboard that blushes when touched a screen that refuses urgency a screen that refuses urgency
hands learning softness hands learning softness a small archive of care a small archive of care a shy machine spirit a shy machine spirit
it will not rush you it will not rush you it will glow only when needed it will glow only when needed it will misbehave politely it will misbehave politely
under a desk lamp at midnight near a plant that survives anyway in a room where time is slower inside a tote bag by the window with quiet air
moonlight moonlight moonlight velvet felt tulle cloud fiber industrial felt
"""